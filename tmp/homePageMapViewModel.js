...
function initMap() {
  ...
  request.onload = function() {
    var reqestDatas = request.response;
    console.log(reqestDatas);
    //地図の作成
    ...
    for (var i = 0; i < reqestDatas.length; i++) {
      reqestdata = new google.maps.LatLng({lat: reqestDatas[i]['address']['lat'], lng: reqestDatas[i]['address']['lng']}); // 緯度経度のデータ作成
